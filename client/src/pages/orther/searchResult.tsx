                ...
                <div className="absolute z-10 mt-2 bg-white text-darkmode-oneColor shadow-lg p-4 w-full rounded-[1.25rem] rounded-tl-[0rem]">
                  <div className="flex flex-col items-start">
                    <button
                      ...
                      onClick={() => handleFilterClick("เรียงตามราคาสูงไปน้อย")}
                    >
                      เรียงตามราคาสูงไปน้อย
                    </button>
                    <button
                      className="w-full text-left p-2 hover:bg-gray-100 rounded"
                      onClick={() => handleFilterClick("เรียงตามราคาน้อยไปสูง")}
                    >
                      เรียงตามราคาน้อยไปสูง
                    </button>
                    <button
                      className="w-full text-left p-2 hover:bg-gray-100 rounded"
                      onClick={() => handleFilterClick("เรียงตามดาวสูงไปน้อย")}
                    >
                      เรียงตามดาวสูงไปน้อย
                    </button>
                    <button
                      className="w-full text-left p-2 hover:bg-gray-100 rounded"
                      onClick={() => handleFilterClick("เรียงตามดาวน้อยไปสูง")}
                    >
